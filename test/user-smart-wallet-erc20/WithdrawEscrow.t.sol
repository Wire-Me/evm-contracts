...
contract UserSmartWalletERC20WithdrawEscrowTest is Test {
    ...
    function testWithdrawEscrowHappyPath() public {
        ...
        userWallet.withdrawEscrow(0);

        assertEq(tokenContract.balanceOf(address(escrowContract)), 0, "Escrow contract should have no funds after withdrawal");
    ...
    function testWithdrawEscrowRevertsIfEscrowIsNotReturned() public {
        vm.startPrank(admin);
